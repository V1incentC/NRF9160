...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_API_RESPONSE_PARSER_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HTTP_CLIENT_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHARED_DATA_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_THREAD_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEAP_MEM_POOL_SIZE, 26288);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAIN_STACK_SIZE, 16288);
